    ...
    <div className="min-h-screen bg-[#371c13] text-white">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <FloatingAnimation duration={4} intensity={8}>
          <HoverAnimation scale={1.1} y={-5}>
            <Button
              size="lg"
              className="bg-[#B27454] hover:bg-[#9a6347] text-white rounded-full shadow-lg animate-pulse"
              asChild
            >
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
        <div className="container mx-auto max-w-6xl text-center">
          <SmartScrollAnimation direction="down" delay={0.2}>
            <div className="mb-8">
              <Badge className="bg-[#FEE1CB] text-[#371c13] text-sm font-medium mb-6">
                Dermatologia Baseada em Evidência
              </Badge>
            </div>
          ...
          <SmartScrollAnimation direction="up" delay={0.8}>
            <HoverAnimation scale={1.05} y={-3}>
              <Button
                size="lg"
                className="bg-[#B27454] hover:bg-[#9a6347] text-white text-lg px-8 py-4 rounded-full"
                asChild
              >
                <a href="https://wa.me/5591999999999" target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-20 px-4 bg-[#FEE1CB]">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <SmartStaggeredAnimation staggerDelay={0.1} direction="up">
              {[
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <SmartScrollAnimation direction="up">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">O que dizem nossos pacientes</h2>
            </div>
          </SmartScrollAnimation>

          <SmartScrollAnimation direction="up" delay={0.2}>
            <Card className="bg-[#FEE1CB] border-none">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 text-[#B27454] fill-current" />
                  ))}
                </div>
                <blockquote className="text-lg text-[#371c13] italic mb-4">
                  "Ele foi o primeiro médico que realmente explicou o que eu tinha, me mostrou as causas e montou um plano
                  comigo. Hoje, tenho clareza e resultados."
                </blockquote>
                <cite className="text-[#371c13] font-medium">— Paciente anônima (acne adulta)</cite>
              </CardContent>
            </Card>
          </SmartScrollAnimation>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <SmartStaggeredAnimation staggerDelay={0.15} direction="up">
              {[
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <SmartScrollAnimation direction="right">
              <div className="text-center md:text-left">
                <div className="mb-6">
                  <h3 className="text-2xl font-bold text-[#B27454] mb-2">Dr. Fábio Dolzany</h3>
                  <p className="text-[#FEE1CB] italic">"Dermatologia com ciência, verdade e humanidade."</p>
                </div>
